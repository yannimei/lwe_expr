...
- The "XRRig" is me (the user). The "MainCamera" gameObject is my head (the user's). The "LeftHand" is my left hand (the user's). The "RightHand" is my left hand (the user's) You don't need to include it in the description.
